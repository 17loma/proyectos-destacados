...
Introduce la ruta de la carpeta que quieras organizar. Comprueba que la ruta sea una carpeta y selecciona solo archivos terminados en `.pdf`, sin distinguir mayúsculas y minúsculas. No recorre subcarpetas. Las rutas relativas se interpretan desde el directorio de ejecución.
